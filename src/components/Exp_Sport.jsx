...
// Componente do Popup para visualização de arquivos
const FileViewerPopup = ({ fileUrl, fileType, onClose }) => {
  ...
  return ReactDOM.createPortal(
    <>
      {/* Botão de fechar FIXO na janela - completamente separado do popup */}
      <button
        onClick={onClose}
...
const SportCard = ({ name, description, image, source_code_link, popfile }) => {
  ...
  return (
    <>
      ...
      {/* Popup para visualização do arquivo */}
      {showPopup && (
        <FileViewerPopup 
          fileUrl={popfile} 
          fileType={fileType}
