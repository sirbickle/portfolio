    ...
    <>
      ...
      <div className="flex items-center min-[1000px]:flex-row flex-col-reverse">
        ...
        >
         ...
         Porém não é só judo que pratiquei, fui vice campeão de Handebol no ensino fundamental no campeonato JES(jogos escolares). Atualmente, ainda pratico esportes, como corrida, onde já participei de 3 maratonas, e faço academia 3 vezes por semana.</p>
