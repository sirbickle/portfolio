...
const translations = {
  pt: {
    ...
    <li><strong>Moscow Institute of Physics and Technology (MIPT)</strong>: Reconhecido pelo sistema "Phystech", que integra rigor teórico com pesquisa aplicada. Interesso-me pelas especializações em Ciências e Tecnologias Geoespaciais (computação aplicada e engenharia aeroespacial) e Física das Tecnologias Avançadas (tecnologias quânticas e nanoeletrônica).</li>
...
//sports
    ...
    <li><strong>Moscow Institute of Physics and Technology (MIPT)</strong>: Renowned for its "Phystech" system that integrates theoretical rigour with applied research. I am particularly interested in specialisations in Geospatial Sciences and Technologies (applied computing and aerospace engineering) and Physics of Advanced Technologies (quantum technologies and nanoelectronics).</li>
  ...
  ru: {
    ...
    <li><strong>Московский физико-технический институт (МФТИ)</strong>: Признан благодаря системе «Физтех», которая интегрирует теоретическую строгость с прикладными исследованиями. Я интересуюсь специализациями в Геопространственных науках и технологиях (прикладные вычисления и аэрокосмическая инженерия) и Физике передовых технологий (квантовые технологии и наноэлектроника).</li>
