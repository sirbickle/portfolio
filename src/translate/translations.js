...
const translations = {
  en: {
    ...
    intro: "Introduction",
    overview: "Overview",
    description: `Hi, I’m Leonardo Lima, I’m 25 years old, I live in Sorocaba, and I have experience as an IT Project Manager, where I have implemented SAP systems in companies such as Braskem, Claro, and Suzano. I was also an IT Support at Atacadão and I have a degree in Technology in Analysis and Systems Development.<br />
    Besides work, I have many interests that help keep my mind active: I am a fan of games, from classics like Warcraft 3 and Starcraft to World of Warcraft and Counter-Strike 2. I also enjoy board games and card games, and from time to time, I play a game of chess.<br />
    ...
    //study
    study: "Study", // Título da seção "Estudo"
    journey_study: `My educational journey study began in 2005 at LEA EDY ALONSO SALIBA Preschool, where I finished my studies in 2006. In 2007, I entered the 1st grade (2nd year) at the same school, where I studied until 2010, when I graduated from the 4th grade (5th year).<br />
    In 2011, I started at a new school, ISABEL LOPES MONTEIRO, where I began the final stretch of my elementary school years. I studied there until 2014, and participated in the handball team, which became vice-champions at the JES competition against Matheus Maylasky school. Although I also participated in the basketball team in the following years, I didn’t achieve remarkable results but had a lot of fun.<br />
    During elementary school, I became interested in learning a new language, so I checked the options at the "CEL" (Center of Languages). They offered several languages: French, Italian, English, Japanese, and German. German caught my attention, both for its pronunciation and for being a culture I was less familiar with, so I thought it would be a great opportunity.<br />
    Although I’m no longer studying German (since I got interested in Russian), I still have great affection for it. It was the key to opening up doors to discover new cultures and learn new languages.<br />
    During the course, I had amazing experiences, from meeting native speakers and having great conversations to the opportunity to visit the country through the Goethe Institute, although I couldn’t go because it was based on a lottery.<br />
    After finishing my studies at ISABEL LOPES MONTEIRO, I went on to study at SENADOR LUIZ NOGUEIRA MARTINS from 2015 to 2017, where I graduated from high school.<br />
    In 2022, I enrolled in the Sorocaba Engineering College as a student of the Technologist in Analysis and Systems Development program, and I graduated in 2024.<br />`,

    //sports
    sport: "Sport",
    journey_sport: `Without a doubt, Judo is something important in my life, I started practicing when I was 7 or 8 years old and stopped when I was 14 or 15 years old. In this sport, I had the honor of participating in the Paulista Judo Federation, traveling to several municipalities in the state of São Paulo for competitions, I trained at the Bandeirantes Sorocaba gym and was a student of Sensei Antonio Rizzardo. <br />
    I have a considerable résumé in Judo regarding competitions, having participated in events since 2007 within Sorocaba and even in other municipalities through the Paulista Judo Federation, with a total of 28 championships won between 2007 and 2013. However, the ones that marked me the most were the Regional and State championships, where I became the champion in the Regional and runner-up in the State. <br />
  ...
  pt: {
    ...
    description: `Oi, eu sou o Leonardo Lima, tenho 25 anos, moro em Sorocaba e tenho experiência como Gerente de Projetos de TI, onde já fiz implementação de sistema SAP em empresas como Braskem, Claro e Suzano, fui Suporte de TI no mercado Atacadão e sou formado em Tecnólogo em Análise e Desenvolvimento de Sistemas.<br />
    Além do trabalho, tenho muitos interesses que me ajudam a manter a mente ativa: sou fã de jogos, desde clássicos como Warcraft 3 e Starcraft até World of Warcraft e Counter-Strike 2. Também gosto de jogos de tabuleiro e de cartas e, de vez em quando, disputo uma partida de xadrez.<br />
    ...
    //study
    study: "Estudo", 
    journey_study: `Minha jornada escolar começou em 2005 na pré-escola LEA EDY ALONSO SALIBA, onde finalizei meus estudos em 2006. Em 2007, ingressei na 1ª série (2º ano) na mesma escola, onde estudei até 2010, quando me formei na 4ª série (5º ano).<br />
    ...
    Apesar de não estar mais estudando essa língua, pois me interessei pelo russo, ainda tenho um grande carinho por ela, sinceramente, foi o que abriu as portas para conhecer novas culturas e aprender novos idiomas.<br />
  ...
  ru: {
    ...
    intro: "Введение",
    overview: "Обзор",
    description: `Привет, я Леонардо Лима, мне 25 лет, я живу в Сорокабе, и у меня есть опыт работы в качестве менеджера проектов в области ИТ, где я внедрял системы SAP в таких компаниях, как Braskem, Claro и Suzano, я также работал в поддержке ИТ в компании Atacadão, и имею высшее техническое образование в области анализа и разработки систем.<br />
    Помимо работы, у меня много интересов, которые помогают держать мой разум в тонусе: я поклонник игр, от классики, такой как Warcraft 3 и Starcraft, до World of Warcraft и Counter-Strike 2. Я также люблю настольные игры и карточные игры, и время от времени играю в шахматы.<br />
    ...
    journey_study: `Мой образовательный путь начался в 2005 году в дошкольном учреждении LEA EDY ALONSO SALIBA, где я завершил учебу в 2006 году. В 2007 году я поступил в 1-й класс (2-й год обучения) в той же школе, где учился до 2010 года, когда окончил 4-й класс (5-й год обучения).<br />
    В 2011 году я начал учёбу в новой школе ISABEL LOPES MONTEIRO, где начал заключительную фазу обучения в начальной школе. Я учился там до 2014 года и участвовал в команде по гандболу, которая стала вице-чемпионами на соревнованиях JES против школы Матейш Майляски. Хотя я также участвовал в баскетбольной команде в следующие годы, мне не удалось достичь выдающихся результатов, но я получил массу удовольствия.<br />
    ...
    Хотя я больше не изучаю немецкий (поскольку заинтересовался русским), у меня всё ещё остаются тёплые воспоминания об этом языке. Он открыл для меня новые культуры и возможность изучать новые языки.<br />
    В ходе обучения я получил потрясающий опыт, общаясь с носителями языка, а также была возможность посетить страну через программу Гёте, хотя я не смог поехать, так как это было основано на лотерее.<br />
    После окончания учёбы в ISABEL LOPES MONTEIRO я продолжил обучение в SENADOR LUIZ NOGUEIRA MARTINS с 2015 по 2017 год и закончил среднюю школу.<br />
    В 2022 году я поступил в факультет инженерии города Сорокаба на программу «Технолог по анализу и разработке систем», окончил обучение в 2024 году.<br />`,

    //sport
    sport: "Спорт",
    journey_sport: `Без сомнений, дзюдо занимает важное место в моей жизни. Я начал заниматься этим спортом в возрасте 7 или 8 лет и прекратил в возрасте 14 или 15 лет. В этом спорте мне посчастливилось участвовать в Федерации дзюдо штата Сан-Паулу, путешествовать по различным городам штата Сан-Паулу для участия в соревнованиях, тренироваться в академии «Bandeirantes» в Сорокабе и быть учеником сенсея Антонио Ризардо.<br />
    ...
    studies_description_project: "Презентация финального проекта первого семестра Фабрики проектов, где задачей было разработать что-то для микрокомпьютера, и мы создали на нем игру, знаменитую «Pac-Ma». Исходя из оригинальной игры, цель заключается в том, чтобы набрать 999 очков, избегая привидений и собирая фрукты.",
    ...
    studies_title_diploma: "Диплом о Завершении Курса «Технолог в Области Анализа и Разработки Систем»",
    ...
    sporties_title_maratona2: "8-й Марафон Сорокабы «Ноябрь Синий»",
    sporties_description_maratona2: "Медаль за участие в 8-м Марафоне Сорокабы «Ноябрь Синий».",
